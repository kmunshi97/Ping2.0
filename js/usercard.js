...
function getUsers(username, rollnum, branch, mail){
    ...
    var userAvatar = document.createElement("img");
        userAvatar.className = "ui tiny circular image";
    ...
    var extraDiv = document.createElement("div");
        extraDiv.className = "extra content right floated";
    
    var mailButton = document.createElement("a");
        mailButton.className = "ui teal icon button";
   
    var addFriendButton = document.createElement("a");
        addFriendButton.className = "ui primary button";
    ...
    contentDiv.appendChild(userAvatar);    
